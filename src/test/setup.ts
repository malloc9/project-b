...
// Note: i18n mocks are now loaded at module import time via src/test/i18n.test.mock.ts
// and should not be re-initialized here to avoid ordering issues.

// Mock Firebase configuration and other test harnesses remain as before
