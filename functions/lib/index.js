 ...
 */
exports.syncPlantCareTask = (0, https_1.onDocumentCreated)("users/{userId}/plantCareTasks/{taskId}", async (event) => {
    var _a, _b;
 ...
 */
exports.syncProject = (0, https_1.onDocumentCreated)("users/{userId}/projects/{projectId}", async (event) => {
    var _a, _b;
    const projectData = (_a = event.data) === null || _a === void 0 ? void 0 : _a.data();
    const userId = event.params.userId;
 ...
 */
exports.syncSimpleTask = (0, https_1.onDocumentCreated)("users/{userId}/simpleTasks/{taskId}", async (event) => {
    var _a, _b;
    const taskData = (_a = event.data) === null || _a === void 0 ? void 0 : _a.data();
    const userId = event.params.userId;
    if (!taskData || !taskData.dueDate)
...
exports.updatePlantCareTaskCalendar = (0, https_1.onDocumentUpdated)("users/{userId}/plantCareTasks/{taskId}", async (event) => {
    var _a, _b, _c;
...
exports.deletePlantCareTaskCalendar = (0, https_1.onDocumentDeleted)("users/{userId}/plantCareTasks/{taskId}", async (event) => {
    var _a;
    const taskData = (_a = event.data) === null || _a === void 0 ? void 0 : _a.data();
    const userId = event.params.userId;
